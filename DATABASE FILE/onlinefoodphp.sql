...
(1, 1, 'The Orchid - All Day Dining Restaurant', 'orchid315@mail.com', '+91 181 500 5500', 'www.fortunehotels.in/', '8am', '8pm', 'mon-sat', '296-297 Lajpat Nagar Fortune Avenue - Member Itc Hotel Group, Jalandhar', '6290877b473ce.jpg', '2022-05-27 08:10:35'),
(2, 2, 'Haveli', 'dm@haveli.co', '+91 98145 99000', 'https://haveli.co/jalandhar/', '6am', '11:30pm', 'Sun-Sat', 'Grand Trunk Road Khajurla, Jalandhar 144001 India', '606d720b5fc71.jpg', '2022-05-27 08:06:41'),
(3, 3, 'Chatter Box', 'ChatterBox@mail.com', '+91 87250 65253', 'www.chatterboxhub.com', '9am', '8pm', 'mon-sat', '507 New Jawahar Nagar Road Shangrila Hotel, Jalandhar ', '6290860e72d1e.jpg', '2022-05-27 08:04:30'),
(4, 4, 'Tawa Parat', 'tawaparatg@mail.com', '+91 75268 40000', 'www.tawaparat.com/', '7am', '8pm', 'mon-sat', 'Adj Kahlon Hospital, Model Town, Jalandhar', '6290af6f81887.jpg', '2022-05-27 11:01:03');
...
SELECT 
    ...
    d.title,
    d.slogan,
    CONCAT('₹', ROUND(d.price, 2)) AS price_in_rupees
FROM 
    dishes d;


UPDATE dishes
SET price = ROUND(price * 80, 2);
